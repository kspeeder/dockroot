...
var defaultUserAgent = "docker/27.3.1 go/go1.23.3 git-commit/41ca978 kernel/6.6.67 os/linux arch/amd64 UpstreamClient(Docker-Client/27.3.1 (linux))"
...
func createApp() (*cobra.Command, *globalOptions) {
	...
	rootCommand := &cobra.Command{
		Use:               "DockRoot",
		Long:              "Run Docker images on more Linux versions using skopeo + ruri .",
	...
	rootCommand.Flags().BoolVarP(&dummyVersion, "version", "v", false, "Version for DockRoot")
